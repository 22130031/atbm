...
<div class="container">
    ...
    <div class="sidebar">
        ...
        <div class="menu-text">
            <p><a href="#">Hồ Sơ</a></p>
            <p><a href="${pageContext.request.contextPath}/security_ui/generate_key.jsp">Tạo khóa</a></p>
            <p><a href="${pageContext.request.contextPath}/security_ui/sign_invoice.jsp">Ký hóa đơn</a></p>
            <p><a href="${pageContext.request.contextPath}/security_ui/verify_invoice.jsp">Xác minh hóa đơn</a></p>
            <p><a href="${pageContext.request.contextPath}/favorite">Sản phẩm yêu thích</a></p>
            <p><a href="${pageContext.request.contextPath}/purchase-history">Lịch sử mua hàng</a></p>
