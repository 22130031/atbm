...
<div class="container mx-auto p-6">
    ...
    <!-- Form ẩn để gửi POST khi ký hóa đơn -->
    <form id="signForm" method="post" action="orders" style="display:none;">
        <input type="hidden" name="action" value="sign">
        <input type="hidden" name="ids" id="signIds">
    </form>
...
<script>
    ...
    function signSelectedInvoices() {
        ...
        // Gán giá trị ids và submit form POST
        document.getElementById("signIds").value = selected.join(",");
